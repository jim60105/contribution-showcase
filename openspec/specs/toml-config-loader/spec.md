...
The system SHALL expose accessors for the `author`, `since`, `until`, `types`, and `exclude_hashes` filter fields after config loading and validation, returning `None` for unset optional filters.
