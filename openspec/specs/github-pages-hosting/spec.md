# Capability: GitHub Pages Hosting

## Purpose

Enable hosting of the pre-built HTML report on GitHub Pages, providing a live demo accessible via a public URL without requiring users to build the project locally.
