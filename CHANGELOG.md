...
- Document new CLI filter flags (`--title`, `--types`, `--exclude-hashes`) and `--timeline-max-buckets` in README
...
[Unreleased]: https://github.com/jim60105/contribution-showcase/compare/v0.4.1...HEAD
[0.4.1]: https://github.com/jim60105/contribution-showcase/compare/v0.4.0...v0.4.1
